...
import { sendAppointmentReminderEmail } from './booking-mail.service';

const FIFTEEN_MINUTES_MS = 15 * 60 * 1000;

const processReminderWindow = async (prisma: PrismaClient) => {
    const now = new Date();
...
export const startAppointmentReminderJob = (prisma: PrismaClient) => {
